...
public class GridCells extends RosMessage {
    ...
    public GridCells(Header header, float width, float height, Point32[] cells) {
        ...
        super.setJsonObject(jsonBuilder().put(FIELD_CELLS, getArray(cells)));
        super.setType(TYPE);
    }
    ...
    public void setCells(Point32... cells) {
        ...
        this.jsonObject.put(FIELD_CELLS, getArray(cells));
    }
    ...
    public void setCells(List<Point32> cells) {
        ...
        this.jsonObject.put(FIELD_CELLS, getArray(this.cells));
    }
