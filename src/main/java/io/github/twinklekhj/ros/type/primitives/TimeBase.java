 ...
 *
 * @param <T> The type of TimeBase used in add and subtract.
 */
public abstract class TimeBase<T extends Primitive> extends Primitive implements Comparable<TimeBase<T>> {
     ...
     * @param type The type of TimeBase primitive.
     */
    ...
    public TimeBase(long nano, String type) {
        ...
        this((int) (nano / TimeBase.SECS_TO_NSECS), (int) (nano % TimeBase.SECS_TO_NSECS), type);
    }
     ...
     * @param nsecs The amount of additional nanoseconds.
     * @param type  The type of TimeBase primitive.
     */
    public TimeBase(int secs, int nsecs, String type) {
        // build the JSON object
        super(jsonBuilder().put(FIELD_SECS, secs).put(FIELD_NSECS, nsecs), type);
        this.secs = secs;
        this.nsecs = nsecs;
    }
     ...
     */
    public long toNSec() {
        return (this.secs * TimeBase.SECS_TO_NSECS) + ((long) this.nsecs);
    }

    /**
     * Compare the given TimeBase object to this one.
     *
     * @param t The TimeBase to compare to.
     ...
     * value.
     *
     * @param t Add the given type to this TimeBase.
     ...
     * that value.
     *
     * @param t Subtract the given type to this TimeBase.
     * @return A new object with the new value.
     */
