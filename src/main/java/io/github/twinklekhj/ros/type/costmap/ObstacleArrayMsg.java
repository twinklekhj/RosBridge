...
public class ObstacleArrayMsg extends RosMessage {
    ...
    public ObstacleArrayMsg(Header header, ObstacleMsg... obstacles) {
        ...
        JsonObject json = jsonBuilder()
                ...
                .put(FIELD_OBSTACLES, getArray(obstacles));
    ...
    public void setObstacles(ObstacleMsg... obstacles) {
        ...
        this.jsonObject.put(FIELD_OBSTACLES, getArray(obstacles));
    }
    ...
    public void setObstacles(List<ObstacleMsg> obstacles) {
        ...
        this.jsonObject.put(FIELD_OBSTACLES, getArray(this.obstacles));
    }
