...
public abstract class Primitive extends JsonWrapper {
     ...
     * positive.
     *
     * @param values The unsigned 8-bit values to convert.
     ...
     * positive.
     *
     * @param values The unsigned 16-bit values to convert.
     ...
     * positive.
     *
     * @param values The unsigned 32-bit values to convert.
     ...
     * positive.
     *
     * @param values The unsigned 64-bit values to convert.
     * @return The values of the given 64-bit unsigned values.
     */
